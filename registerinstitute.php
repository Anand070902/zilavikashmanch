                   ...
                   <div class="col-6">
                       <div class="card bg-success text-white">
                           <div class="card-body">
                               ...
                               <a href="registerinstitute.php" class="nav-link stretched-link m-0 text-white text-center p-0">Register as Institute</a>
                           </div>
                       </div>
                   </div>
                   <div class="col-6">
                       <div class="card bg-dark text-white">
                           <div class="card-body">
                           <h5 class="text-center h3 mb-0"><i class="bi bi-building"></i></h5>
                               <a href="register.php" class="nav-link stretched-link m-0 text-white text-center p-0">Register as Candidate</a>
                           </div>
                       </div>
                   </div>
               </div>
                   ...
                   <div class="card-body">
                       ...
                       <?php
                           if (isset($_POST['create'])) {
                               ...
                               $query=mysqli_query($connect,"insert into accounts (name,email,contact,password,board_name,est_year,type) value ('$name','$email','$contact','$password','$board_name','$est_year','$type')");
