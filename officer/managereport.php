        ...
        <div class="container-fluid p-0">
                <div class="row g-0">
                        ...
                        <div class="col-10 p-4">
                                <div class="row">
                                        <div class="col-8">
                                                <h1 class="h5 fs-bolder">Manage report/Problems</h1></div>
                                ...
                                <table class="table mt-3">
                                        ...
                                        <?php
                                          $callingproject = mysqli_query($connect,"select * from reports JOIN accounts ON reports.account_id = accounts.id JOIN projects ON reports.project_id=projects.pro_id");
                                               ...
                                               <td>       
                                                        <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                        <a href="viewreport.php?rep_id=<?= $row['rep_id'];?>" class="dropdown-item">view details</a>
