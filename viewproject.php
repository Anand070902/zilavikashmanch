        ...
        <div class="row">
            <div class="col-7"> 
                ...
                if(!isset($_SESSION['user'])): ?>
                    <a href="login.php?next=viewproject.php?pro_id=<?= $_GET['pro_id'];?>" class="btn btn-warning mt-5">Sign in to Submit your Project</a>
            ...
            <div class="col-5">
                <div class="card">
                    <img src="image/project/<?= $row['image'];?>"  style="height:280px"  alt="" class="card-img-top w-55">
                </div>
            </div>
            <div class="col-12">
